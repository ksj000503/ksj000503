...
- 🎮 언리얼 엔진 5 기반 **멀티플레이어 게임 클라이언트 개발**에 관심이 많습니다.
- 🧩 Blueprint로 시작해 C++ 게임 시스템과 네트워크 리플리케이션까지 영역을 넓혀가고 있습니다.
- 🛠️ 문제가 생겼을 때 원인을 끝까지 추적해서 해결하는 과정에서 가장 큰 재미를 느낍니다.
...
- **선정 이유** Blueprint만으로 얼마나 확장성 있는 시스템을 설계할 수 있을지 시험해보고 싶어서 시작했습니다. 특히 오브젝트마다 로직을 새로 짜지 않고도 콘텐츠를 늘릴 수 있는 데이터드리븐 구조를 직접 설계해보고 싶었습니다.
